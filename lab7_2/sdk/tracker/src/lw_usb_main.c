...
int main() {
    ...
    XGpio_Initialize(&Gpio_hex, XPAR_GPIO_USB_KEYCODE_DEVICE_ID);
   	...
   	XGpio_Initialize(&Gpio_cursor, XPAR_AXI_CURSOR_DEVICE_ID);
   	XGpio_SetDataDirection(&Gpio_cursor, 1, 0x11111111); //configure hex display GPIO
   	XGpio_SetDataDirection(&Gpio_cursor, 2, 0x11111111); //configure hex display GPIO
