...
HD_PWD='D:/viv/SpartanTracker/lab7_2/lab7_2.runs/mb_block_hdmi_tc_v2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_hdmi_tc_v2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_hdmi_tc_v2_0_0.tcl
