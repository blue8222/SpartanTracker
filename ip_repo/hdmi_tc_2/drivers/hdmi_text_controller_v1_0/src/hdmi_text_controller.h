...
// static volatile struct TEXT_HDMI_STRUCT* hdmi_ctrl = XPAR_HDMI_TEXT_CONTROLLER_0_S_AXI_BASEADDR;
static volatile struct TEXT_HDMI_STRUCT* hdmi_ctrl = (volatile uint32_t*)0x44A00000;
